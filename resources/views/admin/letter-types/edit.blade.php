...
@section('title', 'Edit Jenis Surat: ' . $letterType->name)
@section('header', 'Edit Jenis Surat')
...
<div class="row">
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.letter-types.update', $letterType) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="division_id" class="form-select @error('division_id') is-invalid @enderror" required>
                                ...
                                @foreach($divisions as $div)
                                    <option value="{{ $div->id }}" {{ old('division_id', $letterType->division_id) == $div->id ? 'selected' : '' }}>
                                        {{ $div->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input
                                    ...
                                    id="active"
                                    value="1"
                                    {{ old('active', $letterType->active) ? 'checked' : '' }}
                                >
                        ...
                        <div class="col-12">
                            ...
                            <div id="fields-wrapper">
                                @php
                                    // Prioritaskan old() saat validasi gagal, fallback ke data existing
                                    $existingFields = old('required_fields', $letterType->required_fields ?? []);
                                @endphp

                                @forelse($existingFields as $field)
                    ...
                    <div class="mt-4 d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="ti ti-device-floppy me-1"></i> Perbarui Jenis Surat
                        </button>
